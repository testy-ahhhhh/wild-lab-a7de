...
```
npm create cloudflare@latest -- --template=cloudflare/templates/wild-lab-a7de
```

## Preview Deployment

A live public deployment of this template is available at [https://wild-lab-a7de.templates.workers.dev](https://wild-lab-a7de.templates.workers.dev)
